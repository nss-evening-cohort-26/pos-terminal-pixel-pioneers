    ...
    domString += `
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <hr>
          <i class="btn btn-info" id="update-obj--${obj.firebaseKey}"><span class="fas fa-edit"></span></i>
          <i class="btn btn-danger" id="delete-obj-btn--${obj.firebaseKey}"><span class="fas fa-trash-alt"></span></i>
        </div>
      </div>
      `;
  });
